$(document).ready(function () {
    ...
    $("#btn-active").click(function () {
        ...
        let patientId = dataAttr.patientId;
        ...
        dropzoneOldImages = new Dropzone("#myDropzone-listTour", {
            ...
            init: function () {
                ...
                this.on("sending", function (file, xhr, formData) {
                    formData.append("doctorId", doctorIdSendingImage); // doctorId là ID của tour mà bạn cần gửi
                });
            },
        });
    ...
    $("#send-pdf-btn").click(function () {
        // Lấy appointmentId và email từ button
        const appointmentId = $(this).data("appointmentId");
