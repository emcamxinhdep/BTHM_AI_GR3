                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        ...
                        <div class="menu-btns py-10">
                            <a href="{{ route('appointment.create') }}" class="theme-btn style-two bgc-secondary">
                                <span data-hover="Đặt Ngay">Đặt Lịch Khám</span>
                                ...
                                <li class="drop-down">
                                    <button class="dropdown-toggle bg-transparent" id="userDropdown"
                                        ...
                                        @if (session('patient_avatar'))
                                            <img class="rounded-circle"
                                                src="{{ asset('clients/assets/images/upload/' . session('patient_avatar')) }}"
                                    ...
                                    <ul class="dropdown-menu" id="dropdownMenu">
                                        @if (session()->has('patient_id'))
                                            ...
                                            <li><a href="{{ route('appointments.index') }}">Lịch khám của tôi</a></li>
