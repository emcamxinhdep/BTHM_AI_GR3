            ...
            <div class="col-lg-4">
                <div class="contact-info-content mb-30 rmb-55" data-aos="fade-up" data-aos-duration="1500"
                    ...
                    <div class="section-title mb-30">
                        <h2>Hãy nói chuyện với đội ngũ tư vấn y tế của DoctorCam</h2>
                    </div>
                    <p>Đội ngũ hỗ trợ của DoctorCam luôn sẵn sàng giúp bạn giải đáp các thắc mắc về dịch vụ khám bệnh, đặt lịch hẹn với bác sĩ, tư vấn chuyên khoa và hỗ trợ trong quá trình sử dụng hệ thống.</p>
                    <div class="features-team-box mt-40">
                        <h6>85+ Bác sĩ và chuyên gia y tế</h6>
                ...
                <div class="row">
                        ...
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-envelope"></i> <a
                                        href="mailto:support@doctorcam.vn">support@doctorcam.vn</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                <h5>Trung tâm điều hành DoctorCam</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i>DoctorCam</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="icon"><i class="fas fa-map-marker-alt"></i></div>
                            <div class="content">
                                <h5>Văn phòng hỗ trợ khách hàng</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Group 3</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <div class="comment-form bgc-lighter z-1 rel mb-30 rmb-55">
                    <form id="contactForm" class="contactForm" name="contactForm" action="{{ route('contact.store') }}"
            ...
            <div class="col-lg-5">
                <div class="contact-images-part" data-aos="fade-right" data-aos-duration="1500"
                    ...
                    <div class="circle-logo">
                        ...
                        <span class="title h2">DoctorCam</span>
                    </div>
                </div>
            </div>
        </div>
